        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="rounded-lg bg-muted p-4 md:p-6">
              ...
              <div className="text-2xl md:text-3xl font-bold">₦15,000.00</div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <p className="text-sm md:text-base font-medium text-green-600">+₦10,000</p>
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm md:text-base font-medium">Package Delivery</p>
                    <p className="text-xs text-muted-foreground">Mar 2, 2025</p>
                  </div>
                  <p className="text-sm md:text-base font-medium text-red-600">-₦2,500</p>
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm md:text-base font-medium">Wallet Funding</p>
                ...
                <div className="rounded-lg border p-4">
                  ...
                  <div className="mt-4 space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">LS-12345</span>
                    </div>
                  </div>
