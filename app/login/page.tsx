...
import { Eye, EyeOff, Phone, Lock, Package } from "lucide-react"
...
export default function LoginPage() {
  ...
  useEffect(() => {
    // Check if we're already logged in (in a real app, this would check auth state)
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardTitle className="text-2xl text-center">Sender Login</CardTitle>
